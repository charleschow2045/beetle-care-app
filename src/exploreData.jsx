...
// are Standard Written Chinese (書面語).
  ...
  const SHOPS = [
    {
      ...
      noteZh: "香港甲蟲專門店，供應鍬形蟲、獨角仙及各種護理用品（果凍、木屑、飼養箱）。",
    },
  ];
  ...
  const COMMUNITIES = [
    {
      ...
      noteZh: "香港甲蟲飼主社群，提供教育資訊、物種辨識協助及聚會活動。",
    },
    {
      ...
      noteZh: "台灣老字號甲蟲專賣店網站，提供完整的物種及飼養資訊。",
    },
    {
      name: "台灣蟲店列表 by 黑貓老師",
      region: "Taiwan",
